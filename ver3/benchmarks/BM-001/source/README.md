...
[`source_manifest.yaml`](source_manifest.yaml), alongside this file.
...
**Status: review outstanding, source unfrozen.** The manifest's common
envelope carries `human_review_complete: false`, `frozen: false` and
`authority_status: PROPOSED` — each of which independently blocks the Stage
freeze gate.

**Original wording of the review question:** Two witnesses to the source exist and are not
