"""DeepSeek-VL2 compares the assembly-aware CND-0001 round-1 and round-2 CAD."""
import os, sys
...
- the lid turns about the hinge pin between two required states
...
- body coherence
- hinge continuity, and whether the pin appears to pass through the hinge
- physical connection between base, lid and pin
- plausible rotation between the states
- latch hook and catch coherence, and retention
- detached or floating geometry
- whether version 2 looks more like one manufacturable, assemblable mechanism
...
if __name__ == "__main__":
    names = ["round1_CLOSED_isometric.png", "round1_CLOSED_side.png",
             ...
             "round2_CLOSED_isometric.png", "round2_CLOSED_side.png",
             "round2_OPEN_isometric.png", "round2_OPEN_side.png"]
    ...
    V.run(images, PROMPT, os.path.join(PILOT, "deepseek_vlm_round2_comparison.md"))
