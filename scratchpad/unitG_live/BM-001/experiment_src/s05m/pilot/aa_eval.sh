...
export PILOT_PLAN=${PLAN:-round1_design_plan.json} PILOT_LOG=${LOG:-round1_translation_log.json}
export PILOT_PREFIX=${PREFIX:-round1_} PILOT_CAD=${CAD:-cad_round1}
python $P/evaluate_aa.py
